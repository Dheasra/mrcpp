...
void Update_Nabla_Psi(MultiResolutionAnalysis<3> &MRA, std::vector<mrcpp::CompFunction<3>> &Psi_2c, std::vector<std::vector<mrcpp::CompFunction<3> *>> &Nabla_Psi_2c, ABGVOperator<3> &D){
